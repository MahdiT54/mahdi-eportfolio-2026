...
// Query: *[_type == "skill" && !(category in ["soft-skills", "mobile", "testing", "devops", "design"])] | order(category asc, order asc){  name,  category,  proficiency,  percentage,  yearsOfExperience,  color}
